      ...
      <div class="settings-content">
        <ng-container *ngIf="activeSection() === 'profile'">
          <lib-card title="Profile" subtitle="Update your personal information">
            ...
            <div class="form-actions">
              ...
              <lib-button variant="secondary" (onClick)="resetProfile()"
                >Reset</lib-button
              >
            </div>
          </lib-card>
        ...
        <ng-container *ngIf="activeSection() === 'notifications'">
          ...
          >
            ...
            <div class="form-actions">
              <lib-button (onClick)="saveNotifications()"
                >Save preferences</lib-button
              >
            </div>
          </lib-card>
        </ng-container>
        ...
        <ng-container *ngIf="activeSection() === 'security'">
          ...
          >
            ...
            <div class="form-actions">
              <lib-button (onClick)="changePassword()"
                >Update password</lib-button
              >
            </div>
          </lib-card>
        </ng-container>
...
export class SettingsComponent {
  ...
  changePassword() {
    if (this.security.next !== this.security.confirm) {
