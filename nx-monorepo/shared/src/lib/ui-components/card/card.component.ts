...
@Component({
  ...
  styles: [`
    ...
    .card-elevated { box-shadow:0 4px 6px -1px rgba(0,0,0,.07),0 2px 4px -2px rgba(0,0,0,.05); }
    .card-header { padding:20px 24px 0; }
    .card-title  { margin:0 0 4px;font-size:16px;font-weight:600;color:#0f172a; }
    .card-subtitle { margin:0;font-size:13px;color:#64748b; }
    .card-body   { padding:20px 24px; }
    .card-footer { padding:16px 24px;border-top:1px solid #f1f5f9;background:#f8fafc; }
  `]
})
